...
.method private waitForState(Ljava/lang/String;)Z
    ...
    const-string v7, "/sys/class/android_usb/android0/f_mass_storage/lun/file"

    invoke-direct {v1, v7}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .line 456
    .local v1, "fIn":Ljava/io/File;
    const-string v5, "/system/etc/dop.iso"

    .line 458
    .local v5, "sIn":Ljava/lang/String;
    const/4 v2, 0x0

    .line 460
    .local v2, "frWrite":Ljava/io/FileWriter;
    :try_start_0
    ...
    .end local v2    # "frWrite":Ljava/io/FileWriter;
    .local v3, "frWrite":Ljava/io/FileWriter;
    move-object v2, v3

    .line 466
    .end local v3    # "frWrite":Ljava/io/FileWriter;
    .restart local v2    # "frWrite":Ljava/io/FileWriter;
    :goto_1
    if-eqz v2, :cond_1
    ...
    const-string v8, "waitForState set to PCC mode ..."
    ...
    .end local v2    # "frWrite":Ljava/io/FileWriter;
    .end local v5    # "sIn":Ljava/lang/String;
    :cond_3
    :goto_4
    return v6
    ...
    .restart local v2    # "frWrite":Ljava/io/FileWriter;
    .restart local v5    # "sIn":Ljava/lang/String;
    :catch_0
    move-exception v0
